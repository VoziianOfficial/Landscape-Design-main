export function initMobileMenu(){
  ...
  const closeButton=panel.querySelector('.mobile-panel__close');let lastFocused=null;
  ...
  toggle.addEventListener('click',open);closeButton.addEventListener('click',close);panel.querySelectorAll('a').forEach(link=>link.addEventListener('click',close));
